...
"		{"
"			if(partq[i] == 0)\r\n{	gl_FragColor = vec4(0.5f,0.5f,0.5f,1) / (step*step*0.9) + vec4(0,0,0,1); }\r\n"
"			else if(partq[i] < 0){	gl_FragColor = vec4(1.0f,1.0f,0.5f,1) / (step*step*0.9) + vec4(0,0,0,1); }\r\n"
"			else\r\n"
"				{	gl_FragColor = vec4(0.0f,0.0f,1.0f,1) / (step*step*0.9) + vec4(0,0,0,1); }\r\n"

...
#define MPFR_TUNE_CASE "src/x86_64/pentium4/mpfr_mparam.h"
#include "x86_64/pentium4/mpfr_mparam.h"

#elif (defined (__tune_core2__) || defined (__tune_nocona__)) && defined (__x86_64) /* 64-bit Core 2 or Xeon */
#define MPFR_TUNE_CASE "src/x86_64/core2/mpfr_mparam.h"
#include "x86_64/core2/mpfr_mparam.h"

#elif defined (__tune_core2__) && defined (__i386) /* 32-bit Core 2,
      for example a 64-bit machine with gmp/mpfr compiled with ABI=32 */
#define MPFR_TUNE_CASE "src/x86/core2/mpfr_mparam.h"
#include "x86/core2/mpfr_mparam.h"

#elif defined (__tune_k8__) /* Threshold for AMD 64 */
#define MPFR_TUNE_CASE "src/amd/k8/mpfr_mparam.h"
#include "amd/k8/mpfr_mparam.h"

#elif defined (__tune_athlon__) /* Threshold for Athlon */
#define MPFR_TUNE_CASE "src/amd/athlon/mpfr_mparam.h"
#include "amd/athlon/mpfr_mparam.h"

#elif defined (__tune_pentiumpro__) || defined (__tune_i686__) || defined (__i386) /* we consider all other 386's here */
#define MPFR_TUNE_CASE "src/x86/mpfr_mparam.h"
#include "x86/mpfr_mparam.h"

#elif defined (__ia64) || defined (__itanium__) || defined (__tune_ia64__)
/* Threshold for IA64 */
#define MPFR_TUNE_CASE "src/ia64/mpfr_mparam.h"
#include "ia64/mpfr_mparam.h"

#elif defined (__arm__) /* Threshold for ARM */
#define MPFR_TUNE_CASE "src/arm/mpfr_mparam.h"
#include "arm/mpfr_mparam.h"

#elif defined (__PPC64__) /* Threshold for 64-bit PowerPC, test it before
                             32-bit PowerPC since _ARCH_PPC is also defined
                             on 64-bit PowerPC */
#define MPFR_TUNE_CASE "src/powerpc64/mpfr_mparam.h"
#include "powerpc64/mpfr_mparam.h"

#elif defined (_ARCH_PPC) /* Threshold for 32-bit PowerPC */
#define MPFR_TUNE_CASE "src/powerpc32/mpfr_mparam.h"
#include "powerpc32/mpfr_mparam.h"

#elif defined (__sparc_v9__) /* Threshold for 64-bits Sparc */
#define MPFR_TUNE_CASE "src/sparc64/mpfr_mparam.h"
#include "sparc64/mpfr_mparam.h"

#elif defined (__hppa__) /* Threshold for HPPA */
#define MPFR_TUNE_CASE "src/hppa/mpfr_mparam.h"
#include "hppa/mpfr_mparam.h"

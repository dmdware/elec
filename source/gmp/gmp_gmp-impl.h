...
#endif
//ed
//#include "../mpfr/mpfr_mpfr-impl.h"
//#include "../mpfr/mpfr_mpfr-gmp.h"

//#if 0
#ifndef __GMP_IMPL_H__
#define __GMP_IMPL_H__

#include "../sys/platform.h"	//64/32 bit def's
...
#ifdef _MSC_VER
#define GMP_INLINE	__inline	//e
#else
#define GMP_INLINE	inline	//e
#endif
...
#include "mpn/generic/mpn_gmp-mparam.h"
#include "gmp_fib_table.h"
#include "gmp_fac_table.h"
#include "gmp_mp_bases.h"
#if WANT_FAT_BINARY
#include "fat.h"
#endif
#endif
...
/* Zero n limbs at dst.
   ...
   For power and powerpc we want an GMP_INLINE stu/bdnz loop for zeroing.  On
...
/* Define stuff for gmp_longlong.h.  */
